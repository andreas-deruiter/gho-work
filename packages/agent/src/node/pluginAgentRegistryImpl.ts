import { Emitter, type Event, type PluginAgentDefinition } from '@gho-work/base';
import type { IPluginAgentRegistry } from '../common/pluginAgentRegistry.js';

export class PluginAgentRegistryImpl implements IPluginAgentRegistry {
  private readonly _agents = new Map<string, PluginAgentDefinition>();
  private readonly _onDidChangeAgents = new Emitter<PluginAgentDefinition[]>();
